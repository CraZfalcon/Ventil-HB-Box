...
void sendpulseString() {
  ...
  if (!modem.gprsConnect(apn, gprsUser, gprsPass)) {
    ...
    String httpRequestData = "?HBBoxNumber=" + String(fram.read32(500)) + "&Channel=1" + String(fram.read32(10000)) + "&Channel=2" + String(fram.read32(11000)) + "&Channel=3" + String(fram.read32(12000)) + "&Channel=4" + String(fram.read32(13000)) + "&Channel=5" + String(fram.read32(14000)) + "&Channel=6" + String(fram.read32(15000)) + "&Channel=7" + String(fram.read32(16000)) + "&Channel=8" + String(fram.read32(17000)) + "&Channel=9" + String(fram.read32(18000)) + "&Channel=10" + String(fram.read32(19000)) + "&Channel=11" + String(fram.read32(20000)) + "&Channel=12" + String(fram.read32(21000)) + "&Channel=13" + String(fram.read32(22000)) + "&Channel=14" + String(fram.read32(23000)) + "&Channel=15" + String(fram.read32(24000)) + "&Channel=16" + String(fram.read32(25000));
